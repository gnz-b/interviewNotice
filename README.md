# css， 样式相关
## DOM的reflow & repaint 
[原文链接]: https://juejin.im/entry/58d8d4b3570c350058e27ec6
...
字体大小： em是相对于父元素的，rem是相对于根节点的
position: absolute是相对于relative属性的元素 如果找不到relative的元素 会一直找到body上(ps: absolute是脱离文档流的，不会构成reflow);
